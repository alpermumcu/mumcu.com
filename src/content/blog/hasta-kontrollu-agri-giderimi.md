---
title: Hasta kontrollü ağrı giderimi
...
*   Hasta kontrolün kendi elinde olduğunu bildiği için ameliyat sonrası ağrılar ile ilgili daha az endişe duyar
*   Verilecek olan ağrı kesici miktarı belirlendiği ve kontrol altında olduğu için aşırı doz ağrıkesici alınması engellenmiş olur.
*   Kısa süreli ve düşük dozlarda verildiği için narkotik analjeziklerin bağımlılığa neden olması engellenmiş olur.
*   Ağrı kesici için hazırlık yapılması ve hemşirenin gelmesi ile zaman kaybedilmez.
*   İlacın yutulması ya da kas içine enjekte edilmesi gerekmez. Zaten açık olan damar yolundan yapılır.
*   Ağrıkesicinin kendisi ağrıya neden olmaz.
*   Doktor tarafından belirlenen miktardan fazla ağrı kesici yapılmadığından emin olunabilir.
*   Ağrının dindirilmesi sürekli ve sabit düzeyde olur.
*   Ağrıya neden olabileceği tahmin edilen aktivitelerden önce düğmeye basılarak bu aktiviteler kolaylaştırılabilir Örneğin ayağa kalkmadan 10 dakika önce düğmeye basıldığında ayağa kalkmak çok daha kolay olmaktadır. Hasta ağrı duymadığı için daha sık ve daha uzun dolaşabilmekte bu da ameliyat sonrası ortaya çıkabilecek komplikasyonların görülme riskini azaltmaktadır.
*   Ameliyat sonrası barsak hareketleri daha kısa sürede geri döndüğünden hasta ağızdan beslenmeye daha çabuk başlayabilir
*   Ameliyat sonrası özellikle ilk günün çok daha rahat ve konforlu geçmesi sağlanır.
