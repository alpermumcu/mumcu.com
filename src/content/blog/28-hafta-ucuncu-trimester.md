...
28\. haftada dünyaya gelen bebeklerin yaklaşık %90’ı yaşatılmaktadır. Ancak bu bebeklerde yoğunbakım şartlarında solunum desteği gerekmektedir. Bebeğiniz sürekli uyuma ve uyanma dönemleri geçirmektedir. Zaman zaman gözlerini açıp kapayabilir. Kaşları gelişimini tamamlamıştır. Vücudu yağ depolamaya devam etmektedir. Bu yağlar doğduktan sonra kendi vücut ısısını ayarlamada oldukça önemlidir.
...
**Öneri:**Bu haftada eğer kan grubunuz Rh negatif ise Rhogam yapılmalıdır. Bu anne kanı ile bbek kanının karıştığı durumlarda doğuma kadar etkilenmeyi engeller**.**\[/third\_last\]
