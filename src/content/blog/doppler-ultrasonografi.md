...
![12_dop_kalp](../../assets/images/uploads/2014/03/12_dop_kalp.jpg)Bunlar dışında renkli doppler incelemesi erken dönemde bebeğin kalp atımlarının görülmesi ve dinlenmesi amacıyla da kullanılır. Yandaki fotoğrafta 9 hafta 6 günlük bir gebelikte bebek kalp atımlarının doppler ile incelenmesi izenmektedir.Başka bir uygulama alanı da bebeğin kalbinden çıkan ana damarların gözlenmesidir. Rutin gebelik ultrasonografisi sırasında bebeğin idrar kesesinin iki yanında damarsal yapıların gözlenmesi de olası bir anomali riskini azaltan bir bulgudur.
