...
Cinsel bölgeniz ile ilgili yapılmasi gereken tek şey vulva adı verilen dış bölgelerin sadece su ya da vücut şampuanı ile nazikce yıkanmasıdır. Bu yıkama esnasında çok fazla ovalanması son derece hassas olan ciltte gözle görülemeyen minik yırtılmalara neden olabilir. Bu yırtılmalar ise sizi enfeksiyonlara açık hale getirebilir.

Yıkandıktan sonra genital bölge çok iyi kurulanmalıdır. Nemli kalması bakteri ve mantarların kolaylıkla üremesi için zemin hazırlar.

Bazı kadınlar gential bölgelerinin kokusundan rahatsız olurlar ve bu nedenle kokulu sabun, parfüm, silme mendilleri, gibi ürünleri kullanmayı tercih ederler. Bu uygulamalar aslında son derece sakıncalıdır ve vajinanın asit-baz dengesini bozarak irritasyon, yanma, kaşınma ve enfeksiyon riskini çok arttırırlar.

Genital bölgedeki nemlenmeyi gidermek için kullanılan talk pudrası yumurtalık kanseri riskini arttırdığı için KESİNLİKLE kullanılmamalıdır. Dünyadaki en büyük talk pudrası üreticilerinden birisinin bu bilgiyi gizlediği suçlaması ile milyonlarca dolarlık tazminat davaları ile karşı karşıya kaldığı unutulmamaladır.

Vajina temizliği ile ilgili bir kadının kendine verebileceği en büyük zarar ise vajina içerisini yıkamak yani vajinal duşdur.
