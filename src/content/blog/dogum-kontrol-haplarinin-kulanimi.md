---
title: Doğum kontrol haplarının kulanımı
...
![hap_kullan](../../assets/images/uploads/2014/03/hap_kullan.gif)
...
Akla geldiği anda o hap alınır ve bir sonraki hap normal şekilde kullanılır

Gerekmez

İlk 2 haftada 2 hap unutulursa

Takip eden 2 günde ikişer hap alınır

Şart olmamakla beraber 7 gün ek korunma uygulanabilir.

Eğer 3. haftada 2 hap ya da herhangi bir zamanda ikiden fazla hap unutulursa

Kalan haplar bırakılıp yeni bir kutuya başlanır

Hemen ek bir korunma uygulanmalı ve 7 gün sürdürülmelidir.
...
*   [**Myomlar**](http://www.mumcu.com/html/article.php?sid=1)**:** Myom ile doğum kontrol hapları arasındaki ilişki tartışmalıdır. Eskiden bu ilaçların içerdikleri östrojen nedeni ile myomlarda büyümeye neden olacağı düşünülmekteydi. Ancak yapılan çalışmalarda bu tür bir etki saptanamamıştır. Myomu bulunan kadınlar düşük doz doğum kontrol haplarını güvenle kullanabilirler.
