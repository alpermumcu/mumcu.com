...
Barsaklarda mekonyum adı verilen fetal dışkı birikmeye başlamıştır. Bu dışkı benzeri yapı fetusun yuttuğu amniyon sıvısı, dökülen hücreler ve sindirim sistemi salgılarından oluşur. Macun kıvamında koyu renkli bir yapıdır.
...
**16-20. haftlarda üçlü test yapılır.

\[/third\]

\[third\_last\]

**Öneri:**  Yumurta ve tavuk etinin çok iyi hazırlanması ve pişirilmesi gerekir.Bu besin maddelerinden salmonella enfeksiyonu bulaşabilir. Tavuk hazırlarken kullanılan bıçak vb. gibi malzeme başka bir iş için kullanılmamalıdır. Bu özellikle çiğ olarak tüketilen salata hazırlanırken önem kazanır.\[/third\_last\]
