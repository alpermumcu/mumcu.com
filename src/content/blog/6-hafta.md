...
Döllenmeden sonra 21-23 günlerde embryonun boyu 1.5-3 mm kadar olmuştur. Bu dönemde çok hızlı birbüyüme ve değişim söz konusudur. Somitlerin sayısı 4-12 çift kadardır. Nöral tüp yavaş yavaş kapanmaya başlar. Nöral taç adı verilen kısım ise kafatası ve kafayı oluşturmaya başlar. Omurga diğer kısımlardan daha hızlı büyür ve bu nedenle kuyruğumsu bir görüntü ortaya çıkar. Bu gerçek bir kuyruk değildir. Oluşan 2 endokardial tüp birleşir ve S şeklinde tek bir tüp meydana getiriler. Bu asimetrik oluşum ilkel kalpdir ve bu dönemde kasılmaya başlar. Yani embryonun kalbi atmaya başlamıştır. Kalp hızı ilk başlarda dakikada 80-100 atım arasındadır ve günler ilerledikçe daha da hızlanır.Damarlar gelişmediğinden tam bir dolaşım olmaz.
...
Mercimek tanesi kadar(Yaklaşık 5 milimetre)
